...
if(EXISTS ${_basename}.amdgpu)
    ...
    execute_process(COMMAND /opt/rocm/hcc/compiler/bin/llvm-link ${_basename}.amdgpu ${_basename}.ocml.ll /opt/rocm/lib/ocml.amdgcn.bc /opt/rocm/lib/irif.amdgcn.bc -o ${_basename}.amdgpu.linked)
    execute_process(COMMAND /opt/rocm/hcc/compiler/bin/llc -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -filetype=obj ${_basename}.amdgpu.linked -o ${_basename}.gcn.rel)
